...
const NotebookEdit = React.createClass({
  ...
  //     this.setState({
  //       title: newProps.notebook.title,
  //       creator: newProps.notebook.creator
  //     });
  //   }
  // },
  // handleChange(event) {
  ...
  openForm() {
    hashHistory.push(`/notebooks/${this.props.notebook.id}/edit`);
    // this.setState({
    //   form: <form onSubmit={this.saveChanges}
